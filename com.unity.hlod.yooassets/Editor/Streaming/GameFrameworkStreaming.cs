...
{
    public class GameFrameworkStreaming : IStreamingBuilder
    {
        static class Styles
        {
        ...
        {
            StreamingBuilderTypes.RegisterType(typeof(GameFrameworkStreaming));
        }
        ...
        public GameFrameworkStreaming(IGeneratedResourceManager manager, int controllerID, SerializableDynamicObject streamingOptions)
        {
            m_manager = manager;
            ...
            float cullDistance, float lodDistance, bool writeNoPrefab, bool extractMaterial, Action<float> onProgress)
        {
            ...
            var addressableController = root.AddComponent<GameFrameworkHLODController>();
